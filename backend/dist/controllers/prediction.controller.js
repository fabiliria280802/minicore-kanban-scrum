    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                id = req.params.id;
                return [4 /*yield*/, prediction_1.default.findByPk(id)];
            case 1:
                prediction = _a.sent();
                if (!prediction) {
                    return [2 /*return*/, res.status(404).json({ msg: "Prediction not found", id: id })];
                }
                res.json(prediction);
                return [3 /*break*/, 3];
            case 2:
...
var getPredictions = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var predictions, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, prediction_1.default.findAll()];
            case 1:
                predictions = _a.sent();

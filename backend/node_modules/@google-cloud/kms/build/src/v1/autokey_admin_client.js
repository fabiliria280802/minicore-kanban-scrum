...
exports.AutokeyAdminClient = void 0;
 ...
 */
const gapicConfig = require("./autokey_admin_client_config.json");
...
class AutokeyAdminClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.kms.v1.AutokeyAdmin', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.autokeyAdminStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.kms.v1.AutokeyAdmin')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.kms.v1.AutokeyAdmin, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of autokeyAdminStubMethods) {
            const callPromise = this.autokeyAdminStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    updateAutokeyConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'autokey_config.name': (_a = request.autokeyConfig.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateAutokeyConfig(request, options, callback);
    }
    getAutokeyConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    showEffectiveAutokeyConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.showEffectiveAutokeyConfig(request, options, callback);
    }
    /**
...
exports.AutokeyAdminClient = AutokeyAdminClient;
//# sourceMappingURL=autokey_admin_client.js.map
...
class KeyManagementServiceClient {
    ...
    updateCryptoKey(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'crypto_key.name': (_a = request.cryptoKey.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    updateCryptoKeyVersion(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'crypto_key_version.name': (_a = request.cryptoKeyVersion.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    rawEncrypt(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    rawDecrypt(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
